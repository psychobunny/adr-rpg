...
// Here we check if the admin has deleted the adr_db_update.php file or not.
if(file_exists($phpbb_root_path . 'adr_db_update.'.$phpEx)){
	$message = $lang['Adr_disabled_dbupdate_error'].'<br /><br />'.sprintf($lang['Adr_return'],"<a href=\"" . $direction . "\">", "</a>") ;
